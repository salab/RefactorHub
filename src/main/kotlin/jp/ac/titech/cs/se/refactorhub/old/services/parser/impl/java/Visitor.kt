...
import jp.ac.titech.cs.se.refactorhub.old.models.element.data.Range
import jp.ac.titech.cs.se.refactorhub.old.models.element.impl.ClassDeclaration
import jp.ac.titech.cs.se.refactorhub.old.models.element.impl.CodeFragments
import jp.ac.titech.cs.se.refactorhub.old.models.element.impl.ConstructorDeclaration
import jp.ac.titech.cs.se.refactorhub.old.models.element.impl.InterfaceDeclaration
import jp.ac.titech.cs.se.refactorhub.old.models.element.impl.ParameterDeclaration
...
class Visitor(
    ...
    override fun visit(node: FieldDeclaration): Boolean {
        ...
        node.fragments().forEach {
            ...
            elements.add(
                jp.ac.titech.cs.se.refactorhub.old.models.element.impl.FieldDeclaration(
    ...
    override fun visit(node: MethodDeclaration): Boolean {
        ...
        elements.add(
            jp.ac.titech.cs.se.refactorhub.old.models.element.impl.MethodDeclaration(
                node.name.identifier,
                className,
                Location(path, node.range)
            )
    ...
    override fun visit(node: MethodInvocation): Boolean {
        elements.add(
            jp.ac.titech.cs.se.refactorhub.old.models.element.impl.MethodInvocation(
                methodName,
                className,
                Location(path, node.range)
            )
    ...
    override fun visit(node: VariableDeclarationStatement): Boolean {
        ...
        node.fragments().forEach {
            val fragment = it as VariableDeclarationFragment
            elements.add(
                jp.ac.titech.cs.se.refactorhub.old.models.element.impl.VariableDeclaration(
                    fragment.name.identifier,
                    methodName,
                    className,
                    Location(path, range(startPosition, fragment.endPosition))
