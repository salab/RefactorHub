...
class ReferenceProcessor : AutofillProcessor<Reference> {
    override fun process(autofill: Reference, follow: CodeElement, contents: CommitFileContents): List<CodeElement> {
        ...
        // TODO
        return contents.files.flatMap { it.content.elements }.filter { it is SimpleName && it.name == name }
    }
}
